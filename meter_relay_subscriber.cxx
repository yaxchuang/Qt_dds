...
Example subscription of type two::Relay automatically generated by 
...
int subscriber_main(int domain_id, int sample_count)
{
    ...
    dds::sub::DataReader<two::Relay> reader(dds::sub::Subscriber(participant), topic);
    ...
    {
        // Take all samples
        dds::sub::LoanedSamples<two::Relay> samples = reader.take();
    ...
    while (count < sample_count || sample_count == 0) {
        ...
        // when they activate
        std::cout << "two::Relay subscriber sleeping for 4 sec..." << std::endl;
